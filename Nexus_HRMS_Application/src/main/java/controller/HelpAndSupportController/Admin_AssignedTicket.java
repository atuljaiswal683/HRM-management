...
@WebServlet("/Admin_AssignedTicket")
public class Admin_AssignedTicket extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/helpAndSupport/AdminAssignedTicket.jsp")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/Admin_AssignedTicket");
    }
}
