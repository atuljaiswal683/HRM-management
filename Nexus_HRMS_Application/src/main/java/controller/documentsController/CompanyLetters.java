...
/**
 * Servlet implementation class CompanyLetters
 */
@WebServlet("/CompanyLetters")
public class CompanyLetters extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CompanyLetters() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 request.setAttribute("adminList", li);
		  ...
		  RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/documentsViews/letters.jsp");
