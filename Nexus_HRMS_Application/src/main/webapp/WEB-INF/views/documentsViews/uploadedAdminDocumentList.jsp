            ...
            <div class="container-fluid">
                <nav aria-label="breadcrumb" style="padding-left: 0;">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Admin Uploaded Document List</li>
                    </ol>
                </nav>
            </div>
        </section>
...
<script>
  ...
  //  function viewDocument(uploadId) {
   //     window.open('uploadedAdminDocumentList?uploadId='+uploadId, '_blank');
  //  }

  //  function downloadDocument(uploadId) {
  //      window.location.href = 'uploadedAdminDocumentList?uploadId=' + uploadId;
  //  }

    function deletedocument(id) {
        if(confirm("Are you sure you want to delete document ID " + id + "?")) {
            $.ajax({
                url: '<c:url value="/deleteuploadedAdmin"/>',
                type: 'POST',
                data: { uploadId: id },
