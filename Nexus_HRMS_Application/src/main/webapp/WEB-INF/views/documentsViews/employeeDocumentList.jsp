        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Employee Document List</li>
                </ol>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h5>Employee Document Name List</h5>
                        <button class="btn btn-custom btn-sm" style="margin-left:auto;" onclick="location.href='AddEmpDocumentName'">
...
function saveDocument(id) {
    ...
    $.ajax({
        url: '<c:url value="/editEmpDocName"/>',
        type: 'POST',
