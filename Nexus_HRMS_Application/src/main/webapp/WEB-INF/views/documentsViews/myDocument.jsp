...
.card-white {
    ...
    margin-top: 15px; /* gap below breadcrumb */
}

/* White card ka header styling */
.card-header-custom {
    font-weight: 600;
    font-size: 1.1rem;
    padding-bottom: 10px;
...
#docTable td, #docTable th {
    ...
    vertical-align: middle;
        ...
        /* Action column width adjust */
#docTable th:nth-child(3),
#docTable td:nth-child(3) {
    width: 320px;  /* zarurat ho to aur chhota/bada kar sakte ho */
}
