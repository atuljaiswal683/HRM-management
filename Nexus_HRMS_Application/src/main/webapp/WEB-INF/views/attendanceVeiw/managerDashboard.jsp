...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- Sidebar / Navbar / Footer can be included here -->

    <div class="container mt-4">
        <h3 class="mb-4">Timesheet Approvals</h3>
        ...
        <table class="table table-hover">
            ...
            <tbody>
            <c:forEach var="sheet" items="${pendingList}">
                <tr>
                    <td>${sheet.date}</td>
                    <td>${sheet.userId}</td>
                    <td>${sheet.workingHours}</td>
                    <td>
                        <c:choose>
                            <c:when test="${sheet.status == 'Pending'}">
                    ...
                    <td>
                        <c:if test="${sheet.status == 'Pending'}">
                            <form action="updateTimeSheetStatusServlet" method="post" style="display:inline;">
                                <input type="hidden" name="timeSheetId" value="${sheet.timeSheetId}">
