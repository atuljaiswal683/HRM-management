    ...
    <table class="table table-bordered table-striped">
        ...
        <c:forEach var="leave" items="${leaveTypes}">
            <tr>
                ...
                <td>${leave.status}</td>
                <td>
                    <form action="MasterLeavesServlet" method="post" style="display:inline"
                          onsubmit="return confirm('Are you sure to delete this leave type?');">
                        <input type="hidden" name="action" value="delete" />
                        <input type="hidden" name="id" value="${leave.leaveTypeId}" />
...
<div class="modal fade" id="addLeaveTypeModal" tabindex="-1" role="dialog" aria-labelledby="addLeaveTypeModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="MasterLeavesServlet" method="post">
