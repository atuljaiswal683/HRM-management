...
<form action="DepartmentWiseLeaveServlet" method="post" class="mt-3">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="leaveCount" name="leaveCount" min="1" required />
    </div>
