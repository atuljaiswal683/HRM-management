			...
			<section class="content">
				...
				<div class="card mt-4">
					<div class="card-header">
						<h3 class="card-title">Department Leave Details</h3>
					</div>
					<div class="card-body table-responsive">
						<table id="departmentLeaveDetailsTable"
							...
							<tbody>
								<c:forEach var="leave" items="${departmentLeaves}">
									<tr>
										...
										<td><span
											class="badge badge-${leave.status == 'ACTIVE' ? 'success' : 'danger'}">
												${leave.status == 'ACTIVE' ? 'Active' : 'Inactive'} </span></td>
										<td>
								...
								<c:if test="${empty departmentLeaves}">
									<tr>
										<td colspan="5" class="text-center">No data available in
											table</td>
									</tr>
								</c:if>
							</tbody>
...
$(document).ready(function() {
    $('#departmentLeaveDetailsTable').DataTable({
        dom: 'Bfrtip',
        buttons: [
